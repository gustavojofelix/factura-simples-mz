    ...
    <div class="min-h-screen bg-gray-50 flex">
      ...
      <aside class="w-64 bg-slate-900 text-white flex-shrink-0">
        ...
        <nav class="p-4 space-y-2">
          ...
          <a routerLink="/admin/subscritores" routerLinkActive="bg-slate-800 text-white"
             class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/admin/empresas" routerLinkActive="bg-slate-800 text-white"
             class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/admin/planos" routerLinkActive="bg-slate-800 text-white"
             class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/admin/acessos" routerLinkActive="bg-slate-800 text-white"
             class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/admin/auditoria" routerLinkActive="bg-slate-800 text-white"
             class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
